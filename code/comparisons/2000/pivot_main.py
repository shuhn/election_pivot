...
def main():
    ...
    ******************************************************
    ...
    Would you like to look at Gore (G) or Bush (B)?
    \t>> """
    ...
    if choice1 == 'G':
        ...
        print 'Invalid input, options are \'G\' or \'B\'. Exiting now.'
        exit()
    choice2 = raw_input(menu2)
    if choice2 == 'P' and choice1 == 'GORE:':
        choice2 = 'D'
    elif choice2 == 'P' and choice1 == 'BUSH:':
        choice2 = 'R'
    elif choice2 == 'GE':
        choice2 = 'G'
    else:
