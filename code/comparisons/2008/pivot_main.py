...
def main():
    ...
    ******************************************************
    ...
    Would you like to look at OBAMA (O) or MCCAIN (M)?
    \t>> """
    ...
    if choice1 == 'O':
        ...
        print 'Invalid input, options are \'M\' or \'O\'. Exiting now.'
        exit()
    choice2 = raw_input(menu2)
    if choice2 == 'P' and choice1 == 'OBAMA:':
        choice2 = 'D'
    elif choice2 == 'P' and choice1 == 'MCCAIN:':
        choice2 = 'R'
    elif choice2 == 'GE':
        choice2 = 'G'
    else:
